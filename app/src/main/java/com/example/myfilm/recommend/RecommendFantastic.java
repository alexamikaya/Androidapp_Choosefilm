...
public class RecommendFantastic extends AppCompatActivity {
    ...
    public class RecommendDetective extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            LayoutManager = new LinearLayoutManager(RecommendFantastic.this);
            RecyclerView.setLayoutManager(LayoutManager);
            Adapter = new Adapters(getDataSet(), RecommendFantastic.this);
            ...
            mainmenu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(RecommendFantastic.this, Start.class));
                    finish();
                }
            });
        ...
        private void Recommendation(String key) {
            DatabaseReference filmDb = FirebaseDatabase.getInstance().getReference().child("Films").child("Fantastic").child(key);
