...
public class Fight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference Filmdb = FirebaseDatabase.getInstance().getReference().child("Films").child("Fight");
        ...
        flingContainer.setFlingListener(new SwipeFlingAdapterView.onFlingListener() {
            ...
            public void onLeftCardExit(Object dataObject) {
                ...
                Toast.makeText(Fight.this, "Left", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onRightCardExit(Object dataObject) {
                ...
                Toast.makeText(Fight.this, "Right", Toast.LENGTH_SHORT).show();
            }
        ...
        flingContainer.setOnItemClickListener(new SwipeFlingAdapterView.OnItemClickListener() {
            ...
            public void onItemClicked(int itemPosition, Object dataObject) {
                ...
                Toast.makeText(Fight.this, "Item Clicked", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(Fight.this, Fight.class));
        ...
        mainmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Fight.this, Start.class));
                finish();
            }
        });
    }
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    for (DataSnapshot d : dataSnapshot.getChildren()) {
                        ...
                        Toast.makeText(Fight.this, "new Connect", Toast.LENGTH_LONG).show();
