...
public class RecommendFight extends AppCompatActivity {
    ...
    public class RecommendDetective extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            LayoutManager = new LinearLayoutManager(RecommendFight.this);
            RecyclerView.setLayoutManager(LayoutManager);
            Adapter = new Adapters(getDataSet(), RecommendFight.this);
            ...
            mainmenu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(RecommendFight.this, Start.class));
                    finish();
                }
            });
        ...
        private void Recommendation(String key) {
            DatabaseReference filmDb = FirebaseDatabase.getInstance().getReference().child("Films").child("Fight").child(key);
