...
public class Cartoon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference Filmdb = FirebaseDatabase.getInstance().getReference().child("Films").child("Cartoon");
        ...
        flingContainer.setFlingListener(new SwipeFlingAdapterView.onFlingListener() {
            ...
            public void onLeftCardExit(Object dataObject) {
                ...
                Toast.makeText(Cartoon.this, "Left", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onRightCardExit(Object dataObject) {
                ...
                Toast.makeText(Cartoon.this, "Right", Toast.LENGTH_SHORT).show();
            }
        ...
        flingContainer.setOnItemClickListener(new SwipeFlingAdapterView.OnItemClickListener() {
            ...
            public void onItemClicked(int itemPosition, Object dataObject) {
                ...
                Toast.makeText(Cartoon.this, "Item Clicked", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(Cartoon.this, Cartoon.class));
        ...
        mainmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Cartoon.this, Start.class));
                finish();
            }
        });
    }
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    for (DataSnapshot d : dataSnapshot.getChildren()) {
                        ...
                        Toast.makeText(Cartoon.this, "new Connect", Toast.LENGTH_LONG).show();
