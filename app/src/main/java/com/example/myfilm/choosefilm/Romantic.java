...
public class Romantic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference Filmdb = FirebaseDatabase.getInstance().getReference().child("Films").child("Romantic");
        ...
        flingContainer.setFlingListener(new SwipeFlingAdapterView.onFlingListener() {
            ...
            public void onLeftCardExit(Object dataObject) {
                ...
                Toast.makeText(Romantic.this, "Left", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onRightCardExit(Object dataObject) {
                ...
                Toast.makeText(Romantic.this, "Right", Toast.LENGTH_SHORT).show();
            }
        ...
        flingContainer.setOnItemClickListener(new SwipeFlingAdapterView.OnItemClickListener() {
            ...
            public void onItemClicked(int itemPosition, Object dataObject) {
                ...
                Toast.makeText(Romantic.this, "Item Clicked", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(Romantic.this, Romantic.class));
        ...
        mainmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Romantic.this, Start.class));
                finish();
            }
        });
    }
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    for (DataSnapshot d : dataSnapshot.getChildren()) {
                        ...
                        Toast.makeText(Romantic.this, "new Connect", Toast.LENGTH_LONG).show();
