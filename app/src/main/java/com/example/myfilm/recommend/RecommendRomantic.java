...
public class RecommendRomantic extends AppCompatActivity {
    ...
    public class RecommendDetective extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            LayoutManager = new LinearLayoutManager(RecommendRomantic.this);
            RecyclerView.setLayoutManager(LayoutManager);
            Adapter = new Adapters(getDataSet(), RecommendRomantic.this);
            ...
            mainmenu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(RecommendRomantic.this, Start.class));
                    finish();
                }
            });
        ...
        private void Recommendation(String key) {
            DatabaseReference filmDb = FirebaseDatabase.getInstance().getReference().child("Films").child("Romantic").child(key);
