...
public class RecommendFairytale extends AppCompatActivity {
    ...
    public class RecommendDetective extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            LayoutManager = new LinearLayoutManager(RecommendFairytale.this);
            RecyclerView.setLayoutManager(LayoutManager);
            Adapter = new Adapters(getDataSet(), RecommendFairytale.this);
            ...
            mainmenu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(RecommendFairytale.this, Start.class));
                    finish();
                }
            });
        ...
        private void Recommendation(String key) {
            DatabaseReference filmDb = FirebaseDatabase.getInstance().getReference().child("Films").child("Fairytale").child(key);
