...
public class Fantastic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference Filmdb = FirebaseDatabase.getInstance().getReference().child("Films").child("Fantastic");
        ...
        flingContainer.setFlingListener(new SwipeFlingAdapterView.onFlingListener() {
            ...
            public void onLeftCardExit(Object dataObject) {
                ...
                Toast.makeText(Fantastic.this, "Left", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onRightCardExit(Object dataObject) {
                ...
                Toast.makeText(Fantastic.this, "Right", Toast.LENGTH_SHORT).show();
            }
        ...
        flingContainer.setOnItemClickListener(new SwipeFlingAdapterView.OnItemClickListener() {
            ...
            public void onItemClicked(int itemPosition, Object dataObject) {
                ...
                Toast.makeText(Fantastic.this, "Item Clicked", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(Fantastic.this, Fantastic.class));
        ...
        mainmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Fantastic.this, Start.class));
                finish();
            }
        });
    }
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    for (DataSnapshot d : dataSnapshot.getChildren()) {
                        ...
                        Toast.makeText(Fantastic.this, "new Connect", Toast.LENGTH_LONG).show();
