...
public class RecommendComedy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LayoutManager = new LinearLayoutManager(RecommendComedy.this);
        RecyclerView.setLayoutManager(LayoutManager);
        Adapter = new Adapters(getDataSet(), RecommendComedy.this);
        ...
        mainmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(RecommendComedy.this, Start.class));
                finish();
            }
        });
    ...
    private void getClientId() {
        ...
        DatabaseReference recommendDb = FirebaseDatabase.getInstance().getReference().child("Users").child(clientID).child("connect").child("dontwatch");
    ...
    private void Recommendation(String key) {
        DatabaseReference filmDb = FirebaseDatabase.getInstance().getReference().child("Films").child("Comedy").child(key);
